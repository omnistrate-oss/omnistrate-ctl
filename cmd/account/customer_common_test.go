...
func TestResolveCustomerAccountInstanceByID(t *testing.T) {
	...
	searchInventoryFn = func(ctx context.Context, token string, query string, filters ...openapiclientfleet.SearchInventoryFilters) (*openapiclientfleet.SearchInventoryResult, error) {
