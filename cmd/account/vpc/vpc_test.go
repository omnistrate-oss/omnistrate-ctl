...
func TestParseVPCIDs(t *testing.T) {
	tests := []struct {
		name     string
		raw      string
		expected []string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := parseVPCIDs(tt.raw)
			assert.Equal(t, tt.expected, result)
		})
	}
}

func TestVPCCommandStructure(t *testing.T) {
	// Verify the top-level vpc command has the expected subcommands
	require.NotNil(t, Cmd)
	assert.Equal(t, "vpc [operation] [flags]", Cmd.Use)
...
func TestImportCommandRequiresVPCIDFlag(t *testing.T) {
	require.NotNil(t, importCmd.Flags().Lookup("vpc-id"))
}

func TestUnimportCommandRequiresVPCIDFlag(t *testing.T) {
	require.NotNil(t, unimportCmd.Flags().Lookup("vpc-id"))
}

func TestBulkImportCommandRequiresVPCIDsFlag(t *testing.T) {
	require.NotNil(t, bulkImportCmd.Flags().Lookup("vpc-ids"))
}
